 ...
 * @author Usuario
 */
public class Colaboradores extends javax.swing.JFrame implements ActionListener {
    ...
    private void refrescarTabla() {
        ...
        dtm.setColumnIdentifiers(new String[] {"COLABORADOR_ID","NOMBRE","EMAIL","TELEFONO","FOTO","ACCIÓN1","ACCIÓN2"});
    ...
    private void boton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton1ActionPerformed
        NuevoColaborador nuevoColaborador = new NuevoColaborador();
        nuevoColaborador.setVisible(true);
        this.dispose();
