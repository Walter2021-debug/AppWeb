 ...
 * @author Usuario
 */
public class Categorias extends javax.swing.JFrame implements ActionListener {
    ...
    private void refrescarTabla() {
        ...
        dtm.setColumnIdentifiers(new String[] {"CATEGORIA_ID","NOMBRE","DESCRIPCION","ACCIÓN1","ACCIÓN2"});
        
        List<Categoria> ListaCategorias = LogicaNegocio.getListaCategorias();
        
        for (Categoria categoria : ListaCategorias) {
            dtm.addRow(categoria.toArrayString());
        }
